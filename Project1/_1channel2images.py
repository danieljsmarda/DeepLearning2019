...
def train_model_1C(model, train_input, train_classes, optimizer, mini_batch_size=1000,
                   criterion=torch.nn.CrossEntropyLoss(), nb_epochs=300):
...
def multiple_training_runs(model, nb_runs, optimizer, train_input, train_classes,
    ...
    for i in range(nb_runs):
        ...
        model, time_elapsed = train_model_1C(model, train_input, train_classes, optimizer, 
